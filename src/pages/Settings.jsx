...
//       setPassword("");
//       setProfilePic("");
//       setShowPassword(false); // reset visibility too
...
//         <p className="text-gray-600 mb-10">Manage admins and system configuration</p>
...
//                 className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition pr-12"
//                 required
//               />
//               <button
//                 type="button"
...
//                         onError={(e) => {
//                           e.target.src = "https://via.placeholder.com/56?text=No+Photo";
//                         }}
//                       />
//                     ) : (
